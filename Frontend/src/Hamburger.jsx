    ...
    >
      ...
      >
        <motion.div className="mt-[20vh]" variants={itemVariants}>
          <Link to="/simulation" onClick={onClose}>
            <motion.button
        ...
        <motion.div className="fixed bottom-10 left-0 right-0 flex justify-center gap-20 px-4">
          <Link to="/data" onClick={onClose}>
            <motion.div
              className="flex flex-col text-center items-center bg-zinc-600 font-bold h-40 w-36 justify-center rounded-xl pop select-none hover:bg-zinc-500 transition-colors"
